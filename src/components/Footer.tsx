...
const Footer: React.FC = () => {
  return (
    <footer className="bg-[#153D6D] ">
      <motion.div className="mx-auto max-w-7xl px-6 py-16 sm:py-20 lg:px-8 lg:py-24  sm:flex sm:flex-row flex-col gap-y-5 sm:gap-y-0   sm:justify-between items-center hidden ">
        <motion.div
      ...
      <div className="mx-auto max-w-7xl px-6 py-16 sm:py-20 lg:px-8 lg:py-24  flex sm:flex-row flex-col gap-y-5 sm:gap-y-0   sm:justify-between items-center sm:hidden ">
        <div>
          <h3 className="text-lg font-poppins font-bold leading-6 text-[#EAEAEB] text-center sm:text-left">
            About
          </h3>
