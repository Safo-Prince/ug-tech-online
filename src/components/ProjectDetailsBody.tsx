      ...
      <div className="sm:w-1/2  h-full flex flex-col space-y-4  ">
        ...
        <div>
          ...
          <p className="text-[#56585B] xl:text-lg mt-2">
            ...
            supplement is available in molasses-based, fruit residue-based, rice
            straw- based, pineapple waste based, and urea-molasses based
            varieties.
          </p>
        </div>
        <div>
          ...
          <p className="text-[#56585B] xl:text-lg mt-2">
            ...
            Consequently, ruminants are unable to maintain the appropriate rumen
            environment for effective utilisation of the diet, which impacts
            negatively on ruminant production.
          </p>
        </div>
        <div>
        ...
        <div>
          ...
          <ul className="list-disc list-inside mt-2">
            <li className="text-[#56585B] xl:text-lg ">
              ...
              readily available can take advantage of this technology to improve
              their production.
            </li>
            <li className="text-[#56585B] xl:text-lg">
