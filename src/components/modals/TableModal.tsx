                  ...
                  <div className="mt-3 text-center  sm:mt-0 sm:text-left w-full">
                    ...
                    <div>
                      ...
                      <p className="text-[#56585B] xl:text-lg ">
                        ...
                        fibrous diets in ruminants. The supplement is available
                        in molasses-based, fruit residue-based, rice straw-
                        based, pineapple waste based, and urea-molasses based
                        varieties.
                      </p>
                    </div>
                    <div className="">
                    ...
                    <div>
                      ...
                      <p className="text-[#56585B] xl:text-lg ">Agriculture</p>
                    </div>
                    <div className="mt-2">
                      <h1 className="font-bold  text-lg">Overview</h1>
                      <p className="text-[#56585B] xl:text-lg ">
                        Scarcity of quality feed, especially in the dry season
                        causes ruminants to depend on highly fibrous feeds such
                        as crop residue. Consequently, ruminants are unable to
                        maintain the appropriate rumen environment for effective
                        utilisation of the diet, which impacts negatively on
                        ruminant production.
                      </p>
                    </div>
                    <div className="mt-2">
                      ...
                      <ul className="list-inside list-disc ">
                        <li className="text-[#56585B] xl:text-lg">
                          It improves roughage intake and digestibility by
                          livestock.
                        </li>
                        <li className="text-[#56585B] xl:text-lg ">
                          {" "}
                          promotes growth rate and reproductive efficiency in
                          livestock.
                        </li>
                        <li className="text-[#56585B] xl:text-lg">
                          Offers improved feed utilization and higher growth in
                          ruminants.
                        </li>
                      </ul>
                    </div>
                    ...
                    <div className="mt-2">
                      ...
                      <ul className="list-disc list-inside ">
                        <li className="text-[#007AA0] xl:text-lg ">
                          <a href="https://www.figma.com/file/pmDq4p0rzSmxTGalqrRXRA/UGTechOnline?type=design&node-id=68-158&mode=design&t=gpSdSurRFY4yH5TM-0">
                            Link 1
                          </a>
                        </li>
                      </ul>
